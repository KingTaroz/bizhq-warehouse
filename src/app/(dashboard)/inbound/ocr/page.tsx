...
export default async function OCRPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-foreground mb-2">🤖 รับเข้าด้วย AI (Smart OCR)</h1>
        <p className="text-muted-foreground">ระบบช่วยอ่านและแปลงใบส่งสินค้าเป็นสต๊อกอัตโนมัติ</p>
      </div>
